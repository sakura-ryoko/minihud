...
public class InfoLineHorseSpeed extends InfoLine
{
    ...
    public List<Entry> parse(@NotNull InfoLineContext ctx)
    {
        ...
        {
            Entity vehicle = Objects.requireNonNullElse(this.mc().player, ctx.ent()).getVehicle();
...
//            entityType.equals(EntityType.CAMEL_HUSK) ||
    ...
    public List<Entry> parseEnt(@NotNull World world, @NotNull Entity ent)
    {
        ...
        if (ent instanceof AbstractHorseEntity horse)
        {
            ...
            double speed = horse.getAttributeValue(EntityAttributes.GENERIC_MOVEMENT_SPEED);
