...
public class OverlayRenderer
{
    ...
    public static void renderOverlays(Matrix4f posMatrix, Matrix4f projMatrix, MinecraftClient mc, Camera camera, Profiler profiler)
    {
        ...
        RenderContainer.INSTANCE.render(entity, posMatrix, projMatrix, mc, camera, profiler);
    }
