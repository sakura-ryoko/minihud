...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigBooleanHotkeyed MAIN_RENDERING_TOGGLE             = new ConfigBooleanHotkeyed("mainRenderingToggle", true, "H", KeybindSettings.RELEASE_EXCLUSIVE, "minihud.config.generic.comment.mainRenderingToggle", "MiniHUD Main Rendering", "minihud.config.generic.name.mainRenderingToggle");
