...
public class KeyCallbacks {
    public static void init() {
        ...
        Configs.Generic.ENTITY_DATA_SYNC
                .setValueChangeCallback((config) -> EntitiesDataManager.getInstance().onEntityDataSyncToggled(config));
        Configs.Generic.HUD_DATA_SYNC
                .setValueChangeCallback((config) -> HudDataManager.getInstance().onHudDataSyncToggled(config));
        ...
        Configs.Colors.CONDUIT_RANGE_OVERLAY_COLOR
                .setValueChangeCallback(cfg -> OverlayRendererBeaconRange.INSTANCE.setNeedsUpdate());
        Configs.Colors.LIGHTNING_ROD_RANGE_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererLightningRodRange.INSTANCE.setNeedsUpdate());
        Configs.Colors.LIGHTNING_ROD_DAMAGE_ZONE_COLOR
                .setValueChangeCallback((config) -> OverlayRendererLightningRodRange.INSTANCE.setNeedsUpdate());

        Configs.Generic.LIGHT_LEVEL_RANGE
                .setValueChangeCallback((config) -> OverlayRendererLightLevel.INSTANCE.setNeedsUpdate());
        Configs.Generic.LIGHT_LEVEL_RENDER_THROUGH.setValueChangeCallback(
                (config) -> OverlayRendererLightLevel.INSTANCE.setRenderThrough(config.getBooleanValue()));
        Configs.Generic.STRUCTURES_RENDER_THROUGH.setValueChangeCallback(
                (config) -> OverlayRendererStructures.INSTANCE.setRenderThrough(config.getBooleanValue()));

        Configs.Generic.SPAWN_PLAYER_OUTER_OVERLAY_ENABLED
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());
        Configs.Generic.SPAWN_PLAYER_REDSTONE_OVERLAY_ENABLED
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());
        // Configs.Generic.SPAWN_REAL_OUTER_OVERLAY_ENABLED.setValueChangeCallback((config)
        // -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());
        // Configs.Generic.SPAWN_REAL_REDSTONE_OVERLAY_ENABLED.setValueChangeCallback((config)
        // -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());

        Configs.Colors.SPAWN_PLAYER_ENTITY_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());
        Configs.Colors.SPAWN_PLAYER_REDSTONE_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());
        Configs.Colors.SPAWN_PLAYER_LAZY_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());
        Configs.Colors.SPAWN_PLAYER_OUTER_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_PLAYER.setNeedsUpdate());

        Configs.Colors.SPAWN_REAL_ENTITY_OVERLAY_COLOR
                .setValueChangeCallback((config) -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());
        // Configs.Colors.SPAWN_REAL_REDSTONE_OVERLAY_COLOR.setValueChangeCallback((config)
        // -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());
        // Configs.Colors.SPAWN_REAL_LAZY_OVERLAY_COLOR.setValueChangeCallback((config)
        // -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());
        // Configs.Colors.SPAWN_REAL_OUTER_OVERLAY_COLOR.setValueChangeCallback((config)
        // -> OverlayRendererSpawnChunks.INSTANCE_REAL.setNeedsUpdate());

        RendererToggle.OVERLAY_SLIME_CHUNKS_OVERLAY.getKeybind()
                .setCallback(new KeyCallbackAdjustable(RendererToggle.OVERLAY_SLIME_CHUNKS_OVERLAY,
                        new KeyCallbackToggleBooleanConfigWithMessage(RendererToggle.OVERLAY_SLIME_CHUNKS_OVERLAY)));
        ...
        RendererToggle.OVERLAY_LIGHTNING_ROD_RANGE
                .setValueChangeCallback(RendererCallbacks::onLightningRodRangeToggled);
        ...
        RendererToggle.OVERLAY_RANDOM_TICKS_PLAYER
                .setValueChangeCallback(RendererCallbacks::onRandomTicksPlayerToggled);
        ...
        RendererToggle.OVERLAY_SPAWN_CHUNK_OVERLAY_PLAYER
                .setValueChangeCallback(RendererCallbacks::onSpawnChunksPlayerToggled);
        RendererToggle.OVERLAY_SPAWN_CHUNK_OVERLAY_REAL
                .setValueChangeCallback(RendererCallbacks::onSpawnChunksRealToggled);
        ...
        public boolean onKeyAction(KeyAction action, IKeybind key) {
            ...
            if (key == Configs.Generic.OPEN_CONFIG_GUI.getKeybind()) {
                ...
                if (mc.screen instanceof InventoryOverlayScreen) {
                    ...
                    // RayTraceUtils.InventoryPreviewData inventory =
                    // RayTraceUtils.getTargetInventory(mc);
                    /*
                    ...
                    InventoryOverlayHandler.getInstance().refreshInventoryOverlay(mc,
